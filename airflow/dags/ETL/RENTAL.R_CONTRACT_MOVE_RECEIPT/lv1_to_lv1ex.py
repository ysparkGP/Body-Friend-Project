...
@dag(
    dag_id = 'lv1ex_dag_RENTAL.R_CONTRACT_MOVE_RECEIPT',
...
def refine_address():
    ...
    def check_address():
        ...
        query = '''select distinct A.move_legacy_addr as legacy_addr from lv1.r_contract_move_receipt A left join lv1.address_master B on B.legacy_address = A.move_legacy_addr where B.seq is null and A.move_legacy_addr is not null'''
