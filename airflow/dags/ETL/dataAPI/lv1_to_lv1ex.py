...
@dag(
    dag_id = 'lv1ex_dag_DATAAPI.PUBLIC_INSTITUTION',
...
def refine_address():
    ...
    def check_address():
        ...
        query = '''select distinct A.addr as legacy_addr from lv1.public_institution A left join lv1.address_master B on B.legacy_address = A.addr where B.seq is null and A.addr is not null and A.addr != '' '''
