...
@dag(
    dag_id = 'lv1ex_dag_RENTAL.V_SALES_LOUNGE',
...
def refine_address():
    ...
    def check_address():
        ...
        query = '''select distinct A.legacy_addr from lv1.V_SALES_LOUNGE A left join lv1.address_master B on B.legacy_address = A.legacy_addr where B.seq is null and A.legacy_addr is not null'''
