...
@dag(
    dag_id = "legacy_to_lv0_RENTAL.R_EXPERIENCE_RESERVATION",
...
def etl_dag():
    job_info = {
        'schema' : 'RENTAL',
        'table' : 'R_EXPERIENCE_RESERVATION'
    }
    ...
    def etl_mssql(**context):
        ...
        sql = f"SELECT ORDER_NO, SEQ, CUST_NM, SALES_CHANNEL, SALES_GRP, VISIT_DT, VISIT_NUM, TEL_NO, TEL_NO2, GOODS_CD, GOODS_NM, HOMEPAGE_ID, REMARK, VISIT_STATUS, VISIT_COMPLATE_DATE, ROUTE, ROUTE_CD, CONTRACT_YN, CONTRACT_DATE, CONTRACT_ORDER_NO, MKT_FLAG, MKT_DT, INSRT_USER_ID, INSRT_DT, UPDT_USER_ID, UPDT_DT, REF_ORDER_NO, RECOMMEND_ORDER_NO, INPUT_TYPE, MASSAGE_POINT, MASSAGE_EXP FROM {schema_name}.DBO.{table_name}";
