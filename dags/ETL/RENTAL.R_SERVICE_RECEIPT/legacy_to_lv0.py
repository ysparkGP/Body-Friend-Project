...
@dag(
    dag_id = "legacy_to_lv0_RENTAL.R_SERVICE_RECEIPT",
...
def etl_dag():
    ...
    def etl_mssql(**context):
        ...
        # mssql_root_hook = MsSqlHook(mssql_conn_id='UNI-ERP-ROOT')
        # ms_root_engine = mssql_root_hook.get_conn()
        ...
        while start_page <= total_cnt:
            try:
                ...
                print(f'{start_page} DECRYPT ERROR' )
